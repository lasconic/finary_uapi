...
from .currencies import get_display_currency_code, update_display_currency_by_code
...
def add_user_real_estates(
    ...
    address,
    # currency code used by this real estate object - Currently limited by Finary to "EUR", "USD", "SGD", "CHF", "GBP",or "CAD"
    currency_code,
